...
String getChangelogString() {
  return """
    ...
    When tapping support, Kashu Pro options highlight
    ...
    < 3.8.0
    Kashu pro background now extends past scrollable area - support for (i) over-scroll
